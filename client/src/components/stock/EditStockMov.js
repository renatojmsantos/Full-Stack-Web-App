...
function EditStockMov(props){
  ...
  async function updateQuantity(creationdate, quantity){
    ...
    console.log(date);
    await fetch('http://localhost:7000/stock/'+date, {
          method: 'PATCH',
          mode: 'cors',
    ...
    <Box className="popup">
        ...
        <Box className="popup-inner-dash" sx={{ overflow: "hidden", overflowY: "scroll",
          ...
          transform: 'translate(-50%, -50%)',
            ...
            <Typography marginBottom={2} variant="h5">Edit Quantity of Stock Movement at {getFormatDate(props.move.creationdate)}</Typography>
            ...
            <Typography gutterBottom>
                    ...
                    onClick = {() => updateQuantity(props.move.creationdate, quantity)}
                    >
                      CHANGE
                    </Button>
