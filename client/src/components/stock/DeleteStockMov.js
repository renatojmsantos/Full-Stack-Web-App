...
function DeleteStockMov(props){  
  async function deleteStockMove(){
        // e.g. 2022-03-22T00:52:26.000Z -> 2022-03-22 00:52:26
        
        await fetch('http://localhost:7000/stock/'+creationdate, {
            method: 'DELETE',
            mode: 'cors',
  ...
  let creationdate = props.move.creationdate;
    ...
    <Box className="popup">
        ...
        <Box className="popup-inner-dash" sx={{ overflow: "hidden", overflowY: "scroll",
          ...
          transform: 'translate(-50%, -50%)',
            ...
            <Typography marginBottom={2} variant="h6">Delete Stock Movement at {creationdate}?</Typography>
            <Box textAlign='center' spacing={2}>
                ...
                <Button sx={{marginLeft:5}} variant='contained' color='error' size="medium" onClick = {() => deleteStockMove()}>DELETE</Button>
            </Box>
